Blockly.Blocks['wims_start'] = {
    init: function () {
        ...
        this.setNextStatement(true, 'wims_change_type'); // ovo je posatavljeno 11.12.2018
        this.setColour(0);
        this.setTooltip('');
        this.setHelpUrl('');
    }
...
Blockly.Blocks['wims_declaration'] = {
    ...
    init: function () {
        console.log("BlocklyCustom.js line : 41 wims_declaration");
        this.appendDummyInput()
...
Blockly.Blocks['wims_while'] = {
    init: function () {
        console.log("BlocklyCustom.js line : 28 wims_while");
        this.appendDummyInput()
...
Blockly.Blocks['wims_change_type'] = {
    init: function () {
        console.log("BlocklyCustom.js line : 41 wims_change_type");
        this.appendDummyInput()
        ...
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, 'wims_change_type'); // has changed 11.12.2018
        this.setColour(260);
        this.setTooltip('');
        this.setHelpUrl('');
    }
...
Blockly.Blocks['wims_if'] = {
    init: function () {
        console.log("BlocklyCustom.js line : 64 wims_if");
        this.appendDummyInput()
...
Blockly.Blocks['wims_comment'] = {
    init: function () {
        console.log("BlocklyCustom.js line : 84 wims_comment");
        this.appendDummyInput()
            .appendField("//")
...
Blockly.Blocks['wims_define_variable'] = {
    ...
    init: function () {
        console.log("wims_define_variable");
        console.log("BlocklyCustom.js line : 94 wims_define_variable");
        this.appendDummyInput()
            .appendField(new Blockly.FieldVariable("i"), "VARIABLE_CHOICE")
            .appendField(Blockly.Msg.WIMS_IS_TYPE)
            // this.appendDummyInput()
...
Blockly.Blocks['wims_editor'] = {
    init: function () {
        console.log("BlocklyCustom.js line : 122 wims_editor");
        this.appendDummyInput()
            .appendField(new Blockly.FieldWIMSEditor("", "Quill contents in blockly", false, false), "WIMS_EDITOR");
...
Blockly.Blocks['wims_variable_editor'] = {
    init: function () {
        console.log("BlocklyCustom.js line : 133 wims_variable_editor");
        this.appendDummyInput()
...
Blockly.Blocks['wims_up_down_editor'] = {
    init: function () {
        console.log("BlocklyCustom.js line : 148 wims_up_down_editor");
        this.appendDummyInput()
...
Blockly.Blocks['wims_for'] = {
    init: function () {
        console.log("BlocklyCustom.js line : 180 wims_for");
        this.appendDummyInput()
...
Blockly.Blocks['analyse_feedback'] = {
    init: function () {
        console.log("BlocklyCustom.js line : 205 analyse_feedback");
        this.appendDummyInput()
...
Blockly.Variables.flyoutCategory = function (workspace) {
    ...
    console.log("BlocklyCustom.js flyoutCategory variables list : "+ variableList);
    ...
    {
        console.log("BlocklyCustom.js flyoutCategory if condition");
