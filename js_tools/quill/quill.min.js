...
! function(t, e) {
    ...
    return function(t) {
        ...
        function r(t, e) {
            ...
            var r = n,
                o = t instanceof Node ? t : r.create(e);
            return new r(o, e)
        }
        ...
        var h = n(8),
            ...
            S = function() {
                function t(e) {
                    ...
                    if (i(this, t), this.options = l(e, r), this.container = this.options.container, this.scrollingContainer = this.options.scrollingContainer || document.body, null == this.container) return P.error("Invalid Quill container", e);
                    this.options.debug && t.debug(this.options.debug);
                    var o = this.container.innerHTML.trim();
                    this.container.classList.add("ql-container"), this.container.innerHTML = "", this.container.__quill = this, this.root = this.addContainer("ql-editor"), this.root.classList.add("ql-blank"), this.emitter = new g.default, this.scroll = w.default.create(this.root, {
        ...
        S.DEFAULTS = {
            ...
            strict: !0,
            theme: "default"
        }, S.events = g.default.events, S.sources = g.default.sources, S.version = "1.2.2", S.imports = {
            delta: d.default,
            parchment: w.default,
        ...
        var o = function() {
            ...
            i = function() {
                function t(e, n) {
                    var o = this;
                    r(this, t), this.quill = e, this.boundsContainer = n || document.body, this.root = e.addContainer("ql-tooltip"), this.root.innerHTML = this.constructor.TEMPLATE, this.quill.root.addEventListener("scroll", function() {
                ...
                "checklist enter": {
                    ...
                    handler: function(t) {
                        ...
                        var e = this.quill.getLine(t.index + 1),
                            n = y(e, 1),
                            r = n[0];
                        r.format("list", "unchecked"), this.quill.update(N.default.sources.USER), this.quill.setSelection(t.index + 1, N.default.sources.SILENT), this.quill.selection.scrollIntoView()
                    }
                },
                "header enter": {
                    key: M.keys.ENTER,
                ...
                "list autofill": {
                    ...
                    handler: function(t, e) {
                        ...
                        var n = e.prefix.length,
                            r = 1 === e.prefix.trim().length ? "bullet" : "ordered";
        ...
        var a = function() {
            ...
            f = function(t) {
                ...
                return l(e, t), a(e, [{
                    ...
                    key: "canAdd",
                    value: function(t, n) {
                        return s(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "canAdd", this).call(this, t, n) || s(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "canAdd", this).call(this, t, parseInt(n))
                    }
                }, {
                    key: "value",
                    value: function(t) {
        ...
        var w = function() {
            ...
            K = [C.AlignAttribute, I.DirectionAttribute].reduce(function(t, e) {
                return t[e.keyName] = e, t
            }, {}),
            z = [C.AlignStyle, M.BackgroundStyle, R.ColorStyle, I.DirectionStyle, B.FontStyle, D.SizeStyle].reduce(function(t, e) {
                return t[e.keyName] = e, t
            }, {}),
            Z = function(t) {
                function e(t, n) {
        ...
        s.blotName = "scroll", s.defaultChild = "block", s.scope = i.Scope.BLOCK_BLOT, s.tagName = "DIV", e.default = s
    }, function(t, e, n) {
        "use strict";
        var r = this && this.__extends || function() {
            var t = Object.setPrototypeOf || {
